...
export class Project {
    ...
    constructor($$source: Partial<Project> = {}) {
        ...
        if (!("Visibility" in $$source)) {
            this["Visibility"] = Visibility.$zero;
        }
...
export class ProjectSampleMembership {
    "Creator": User;
    "Timestamp": time$0.Time;
    "Label": string;

    /** Creates a new ProjectSampleMembership instance. */
    constructor($$source: Partial<ProjectSampleMembership> = {}) {
        if (!("Creator" in $$source)) {
    ...
    /**
     * Creates a new ProjectSampleMembership instance from a string or object.
     */
    static createFrom($$source: any = {}): ProjectSampleMembership {
        const $$createField0_0 = $$createType24;
        let $$parsedSource = typeof $$source === 'string' ? JSON.parse($$source) : $$source;
        if ("Creator" in $$parsedSource) {
            $$parsedSource["Creator"] = $$createField0_0($$parsedSource["Creator"]);
        }
        return new ProjectSampleMembership($$parsedSource as Partial<ProjectSampleMembership>);
    }
}
...
export class ProjectSampleResources {
    ...
    constructor($$source: Partial<ProjectSampleResources> = {}) {
        ...
        if (!("ProjectMembership" in $$source)) {
            this["ProjectMembership"] = (new ProjectSampleMembership());
        }
        if (!("ProjectTags" in $$source)) {
            this["ProjectTags"] = [];
        }
    ...
    static createFrom($$source: any = {}): ProjectSampleResources {
        ...
        if ("ProjectMembership" in $$parsedSource) {
            $$parsedSource["ProjectMembership"] = $$createField3_0($$parsedSource["ProjectMembership"]);
        }
        if ("ProjectTags" in $$parsedSource) {
            $$parsedSource["ProjectTags"] = $$createField4_0($$parsedSource["ProjectTags"]);
        }
        if ("ProjectNotes" in $$parsedSource) {
            $$parsedSource["ProjectNotes"] = $$createField5_0($$parsedSource["ProjectNotes"]);
        }
        if ("Data" in $$parsedSource) {
            $$parsedSource["Data"] = $$createField6_0($$parsedSource["Data"]);
        }
        if ("DataSchemas" in $$parsedSource) {
            $$parsedSource["DataSchemas"] = $$createField7_0($$parsedSource["DataSchemas"]);
        }
        if ("Users" in $$parsedSource) {
            $$parsedSource["Users"] = $$createField8_0($$parsedSource["Users"]);
        }
        if ("UserPermissions" in $$parsedSource) {
            $$parsedSource["UserPermissions"] = $$createField9_0($$parsedSource["UserPermissions"]);
        }
...
export enum SampleUserPermission {
    /**
     * The Go zero value for the underlying type of the enum.
     */
    $zero = "",

    SAMPLE_USER_PERMISSION_OWNER = "owner",
    SAMPLE_USER_PERMISSION_READ = "read",
    SAMPLE_USER_PERMISSION_ADD_DATA = "add_data",
    SAMPLE_USER_PERMISSION_CREATE_NOTE = "create_note",
    SAMPLE_USER_PERMISSION_MODIFY_PROPERTIES = "modify_properties",
};

export class SampleUserPermissions {
    "User": uuid$0.UUID;
    "Permissions": SampleUserPermission[];

    /** Creates a new SampleUserPermissions instance. */
    constructor($$source: Partial<SampleUserPermissions> = {}) {
        if (!("User" in $$source)) {
            this["User"] = "";
        }
    ...
    /**
     * Creates a new SampleUserPermissions instance from a string or object.
     */
    static createFrom($$source: any = {}): SampleUserPermissions {
        ...
        return new SampleUserPermissions($$parsedSource as Partial<SampleUserPermissions>);
    }
}
...
const $$createType24 = User.createFrom;
const $$createType25 = ProjectSampleMembership.createFrom;
const $$createType26 = ProjectSampleNote.createFrom;
const $$createType27 = $Create.Array($$createType26);
const $$createType28 = $Create.Array($$createType24);
const $$createType29 = SampleUserPermissions.createFrom;
