...
export default function () {
  ...
  async function create_project(e: FormEvent<HTMLFormElement>) {
    ...
    const visibility = common.visibility_string_to_variant(visibility_str);
    if (!visibility) {
      console.error(`invalid project visibility: ${visibility_str}`);
      const input = document.getElementById("visibility")! as HTMLSelectElement;
          ...
          <div className="flex gap-2 items-start w-full">
            <button
              ...
              className={classNames({
                "border-2 px-2 py-0.5 rounded-full cursor-pointer": true,
