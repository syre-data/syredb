  ...
  return (
    <div>
      <div className="flex px-4 py-2">
        ...
        <div>
          <button type="button" className="btn-cmd" onMouseDown={close}>
            <icon.Close />
          </button>
        </div>
      </div>
          ...
          <section className="px-4 pb-2 grid grid-cols-[repeat(2,min-content)] gap-2">
            <div className={FORM_ROW_CLASSNAME}>
              <label className="contents">
                ...
                <input
                  type="text"
                  defaultValue={sample_resources.ProjectMembership.Label}
                  placeholder="Label"
    ...
    <section>
      ...
      <div className="grid gap-2 grid-cols-[]">
        {properties.map((property) => (
          <PropertyStatic property={property} className={FORM_ROW_CLASSNAME} />
        ))}
      </div>
    </section>
  );
